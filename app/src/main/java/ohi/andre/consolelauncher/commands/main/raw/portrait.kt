...
class portrait : CommandAbstraction {
    override fun exec(pack: ExecutePack): String? = orientation.apply(pack, orientation.MODE_PORTRAIT)

    override fun argType(): IntArray = intArrayOf()

    override fun priority(): Int = 4

    override fun helpRes(): Int = R.string.help_portrait
